function [Packet] = BlockChar(myEBSD,Grains,gId,Packet,Twin)
    ...
    if Grains.grainId(gId,2) == TransID
        ...
        while count < length(twnnum)
            ...
            [Vtmp,flag] = YardleyVariants(ksi);
            [Gtmp,CT] = GroupoidVariantsCubic(Vtmp);
            ...
            for Pck = 1:4
                ...
                if Flg==0
                    ...
                    for Blck = 1:3
                        ...
                        Blck_rotg2t = Aus_or(ii) * Blck_g2t;
%                         Blck_rotc2g = Aus_or(ii) * Blck_c2g;
...
%                           PckGraph=addedge(PckGraph,(1:len)+1,(1:len)+PckEndnode,c2g_wts);
                ...
                PckBlckInds{Pck} = tmpInds{ii}(PckInds);
