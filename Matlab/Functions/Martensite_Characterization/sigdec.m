function y = sigdec(x, n)
%SIGDEC Round with a specified number of decimals.
%   A slight modification of Peter J. Acklam's FIXDIG
%
%   Y = SIGDEC(X, N) rounds the elements of X to N decimals.
%
%   For instance, fixdec(10*sqrt(2) + i*pi/10, 4) returns 14.1421 + 0.3141i
%
%   See also: FIX, FLOOR, CEIL, ROUND, FIXDIG, ROUNDDEC, ROUNDDIG.

%   Author:     Eric J. Payton, Peter J. Acklam
%   Time-stamp:  2010-05-22
%   E-mail:      payton.28[at]osu.edu
%   URL:         
