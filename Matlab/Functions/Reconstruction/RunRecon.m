...
%THIS IS WRONG. Fix later. if we hardcode the OR, we need to also hardcode
%the halfwidth of the noise.
%    OR_Flag = 0;
...
myEBSD.AusGrains = PA_Grains;
myEBSD.ASTMGrains = Grains;
